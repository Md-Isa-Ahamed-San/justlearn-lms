export function AnswerComparison({
  ...
  const getSubmittedAnswerDisplay = () => {
    ...
    // For text-based answers, handle both array and string formats
  ...
  // Handle empty or "i dont know" type answers
  const isEmptyAnswer = !submittedDisplay ||
      submittedDisplay.trim().toLowerCase() === 'i dont know' ||
      submittedDisplay.trim() === ''
  ...
  return (
      <div className="space-y-4">
        ...
        <div>
          ...
          {marksAwarded > 0 && marksAwarded < totalMarks && (
        ...
        {/* Correct Answer Section (only show if incorrect or partial) */}
        {!isCorrect && (
            <div>
            ...
            <div className="mt-4">
              ...
              <div className="space-y-2">
                {options.map((option, index) => {
                  const isSelected = option.label === submittedDisplay
