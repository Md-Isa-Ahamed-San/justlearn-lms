...
import QuizQuestion
    from "@/app/(main)/courses/[id]/quiz-participation/[quizId]/_component/quizInterface/_components/quiz-question";
import {Alert, AlertDescription} from "@/components/ui/alert";
import {ChevronLeft, ChevronRight, WifiOff} from "lucide-react";
import {Button} from "@/components/ui/button";

const QuestionInterface = ({currentQuestion,
                               state,
        ...
        <div className="lg:col-span-3">
            <Card className="bg-card border-border">
                <CardContent className="p-6">
                    ...
                    {/* Navigation Controls */}
                    <div
                        className="flex flex-col sm:flex-row gap-4 justify-between items-center mt-8 pt-6 border-t border-border">
                        {/* Previous Button */}
                        <Button
                            variant="outline"
