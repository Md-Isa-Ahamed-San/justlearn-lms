  ...
  return (
    <div className="w-full space-y-1">
      <div className="flex items-center justify-between text-xs">
        ...
        <span className={cn("font-medium", variant === "success" ? "text-emerald-600" : "text-muted-foreground")}>
          {value}%
        </span>
      </div>
      <Progress
        value={value}
        className={cn("h-1.5", variant === "success" ? "bg-emerald-100 [&>div]:bg-emerald-600" : "")}
      />
    </div>
  )
}
  ...
  return (
    <div>
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-3 text-lg text-gray-600 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-xl md:mt-5">
              Master React JS & Next JS through hands-on projects and real-world applications
            </p>
                ...
                <div className="mt-2 flex items-center gap-6">
                  <div className="flex items-center gap-2">
                    <Avatar className="h-10 w-10">
                      <AvatarImage src="https://avatars.githubusercontent.com/u/3633137?v=4" alt="Tapas Adhikary" />
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <div className="prose max-w-none ">
                      <p>
                        This comprehensive course will help you master React and Next.js quickly and thoroughly. You'll
                        learn modern development practices and build real-world applications that showcase your skills
                        to potential employers.
                      </p>
                      <p>
                        You'll be exposed to principles and strategies, but, more importantly, you'll learn how to
                        actually apply these abstract concepts by coding three different websites for three very
                        different audiences. By the end of this course, you'll have a portfolio of projects that
                    ...
                    {[
                      {
                        ...
                        lessons: [
                          ...
                          { title: "Your first React component", type: "video" },
                        ],
                      },
                      {
                        id: "item-2",
                        ...
                        lessons: [
                          ...
                          { title: "Server-side rendering vs. Static generation", type: "video" },
                      ...
                      },
                      {
                        ...
                        lessons: [
                          { title: "Project overview and requirements", type: "video" },
                          { title: "Setting up the database", type: "video" },
                          { title: "Creating product listings", type: "video" },
                          { title: "Implementing the shopping cart", type: "video" },
                          { title: "Processing payments", type: "video" },
                          { title: "Deployment and optimization", type: "video" },
                        ],
                      },
                    ].map((section) => (
                      <AccordionItem key={section.id} value={section.id} className="border-b border-gray-200 px-0">
                        ...
                        <AccordionContent className="pb-6">
                          <div className="mb-4 flex flex-wrap items-center gap-4 rounded-lg  p-4 text-sm">
                            <div className="flex items-center gap-1.5">
                              ...
                              {section.lessons.filter((l) => l.type === "video").length} Videos
                            </div>
                            <div className="flex items-center gap-1.5">
                              <FileText className="h-4 w-4 " />
                              {section.lessons.filter((l) => l.type === "note").length} Notes
                            </div>
                            <div className="flex items-center gap-1.5">
                  ...
                  <div className="flex flex-col gap-8 md:flex-row">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600">
                        Tapas is a passionate educator and developer with over 15 years of experience in the software
                        industry. He specializes in React, Next.js, and modern JavaScript frameworks, having worked with
                        companies ranging from startups to Fortune 500 enterprises. His teaching approach focuses on
                        practical, project-based learning that helps students build real-world skills.
                      </p>
                    </div>
                  </div>
                </div>
                          ...
                          <div className="flex ">
                            {Array(5)
                              ...
                              .map((_, i) => (
                                <Star
                                  key={i}
                                  className={cn("h-4 w-4", i < testimonial.rating ? "fill-current" : "")}
                                />
                              ))}
                          </div>
                        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl">
            <h2 className="mb-12 text-center text-3xl font-bold">Related Courses</h2>
